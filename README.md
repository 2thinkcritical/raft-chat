...
- `DATABASE_URL` - URL PostgreSQL (по умолчанию: postgresql://chatuser:chatpass@postgres:5432/chatdb)
...
- **Эмбеддинги**: Ollama mxbai-embed-large модель
- **LLM**: OpenAI GPT-4 для генерации ответов
- **Документ**: HIPAA PDF для демонстрации
